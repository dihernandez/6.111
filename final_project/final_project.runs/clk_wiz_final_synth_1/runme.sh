...
HD_PWD='/afs/athena.mit.edu/user/d/i/dianah13/ddl/6.111/final_project/final_project.runs/clk_wiz_final_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_final.tcl
