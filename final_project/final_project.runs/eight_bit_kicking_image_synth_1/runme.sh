...
HD_PWD='/afs/athena.mit.edu/user/d/i/dianah13/ddl/6.111/final_project/final_project.runs/eight_bit_kicking_image_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eight_bit_kicking_image.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eight_bit_kicking_image.tcl
