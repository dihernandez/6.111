...
module iir_filter (
        ...
        input [18:0] prev_delta_size_out, // prev iir output for change in size
        input [12:0] dx_val_in, // delta x coord input
        input [12:0] dy_val_in, // delta y coord input
        input [18:0] delta_size_in, // delta size input
        output logic [12:0] dx_val_out, // iir output for delta x 
        output logic [12:0] dy_val_out, // iir output for delta y
        output logic [18:0] delta_size_out // iir output for delta size
    ); 
